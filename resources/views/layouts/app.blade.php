            ...
            <div class="container">
                <div class="nav-left">
                    <a class="nav-item" href="{{route('home')}}">
                        <img src="{{asset('images/egpaf-logo.jpg')}}" alt="EGPAF Logo" />
                    </a>
                    <a href="#" class="nav-item is-tab is-hidden-mobile m-l-10">Home</a>
                    <a href="#" class="nav-item is-tab is-hidden-mobile">About</a>
                    <a href="#" class="nav-item is-tab is-hidden-mobile">Testmonials</a>
                 </div>
                <div class="nav-right" style="overflow: visible;">
                    @if (Auth::guest())
                        <a href="{{route('login')}}" class="nav-item is-tab">Login</a>
                        <a href="{{route('register')}}" class="nav-item is-tab">Jiunge</a>
                        @else
                        <button class="dropdown is-aligned-right nav-item is-tab">
                            Hey Felician <span class="icon"><i class="fa fa-caret-down"></i></span>
